...
var SOURCE_ANDROID_ICON = 'resources/android/icon/';
var SOURCE_ANDROID_SPLASH = 'resources/android/splash/';
var TARGET_ANDROID_ICON = 'android/app/src/main/res/';
var TARGET_ANDROID_SPLASH = 'android/app/src/main/res/';
/*
const IOS_ICONS = [
...
var ANDROID_SPLASHES = [// { source: 'drawable-land-ldpi-screen.png', target: 'splash.png' }, // Not created by capacitor
{
...
function copyImages(sourcePath, targetPath, images) {
  ...
  try {
    var _loop = function _loop() {
      ...
      var source = sourcePath + icon.source;
      var target = targetPath + icon.target;
